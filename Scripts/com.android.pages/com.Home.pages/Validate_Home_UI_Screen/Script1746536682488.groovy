...
WebUI.callTestCase(findTestCase('com.android.pages/com.Home.pages/Verify_Hyper_Links'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.android.pages/com.Home.pages/Verify_Search_Section'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.android.pages/com.Home.pages/Verify_your_exact_location_text'), [:], FailureHandling.STOP_ON_FAILURE)
