...
String actualMessage = Mobile.getText(findTestObject('Android/change_password_object_repository/android.widget.TextView - Change Password Successful'), 
    0)

println('actualMessage: ' + actualMessage)

String expectedMessage = CustomKeywords.'test.data.MessageValidator.validateMessage'(3)
