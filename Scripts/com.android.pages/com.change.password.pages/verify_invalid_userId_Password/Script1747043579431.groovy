...
Mobile.verifyElementExist(findTestObject('Object Repository/Android/Sign_In_object_repository/android.widget.TextView - Login Screen'), 
    0)

String actualMessage = Mobile.getText(findTestObject('Object Repository/Android/Sign_In_object_repository/android.widget.TextView - Invalid User IdPassword'), 
    0)

println('actualMessage: ' + actualMessage)

String expectedMessage = CustomKeywords.'test.data.MessageValidator.validateMessage'(4)
