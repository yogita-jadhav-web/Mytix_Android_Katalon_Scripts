...
String actualMessage = Mobile.getText(findTestObject('Android/create_account_object_repository/android.widget.TextView - Password and Confirm Password does not match'), 
    0)

println('actualMessage: ' + actualMessage)

String expectedMessage = CustomKeywords.'test.data.MessageValidator.validateMessage'(6)
