...
String actualMessage = Mobile.getText(findTestObject('Object Repository/Android/create_account_object_repository/android.widget.TextView - Password cannot be empty'), 
    0)

println('actualMessage: ' + actualMessage)

String expectedMessage = CustomKeywords.'test.data.MessageValidator.validateMessage'(16)
