...
WebUI.callTestCase(findTestCase('com.android.pages/com.Onboarding.pages/Click_on_Skip'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.android.pages/com.Home.pages/Validate_Home_UI_Screen'), [:], FailureHandling.STOP_ON_FAILURE)
