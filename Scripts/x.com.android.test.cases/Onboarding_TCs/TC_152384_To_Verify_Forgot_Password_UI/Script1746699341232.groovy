...
WebUI.callTestCase(findTestCase('com.android.pages/com.sign.in.pages/User_is_navigated_to_Sign_in_UI'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.android.pages/com.sign.in.pages/Enter_Sign_In_Credentials'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.android.pages/com.Home.pages/Validate_Home_UI_Screen_after_signIn'), [:], FailureHandling.STOP_ON_FAILURE)
