...
WebUI.callTestCase(findTestCase('com.android.pages/com.Enable.Location.pages/Click_Allow_Location'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.android.pages/com.Enable.Location.pages/Click_on_While using the app'), [:], FailureHandling.STOP_ON_FAILURE)
