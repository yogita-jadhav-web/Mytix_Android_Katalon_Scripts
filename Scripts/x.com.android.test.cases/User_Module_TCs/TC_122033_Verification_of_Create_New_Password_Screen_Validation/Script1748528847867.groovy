...
CustomKeywords.'kw_random.PasswordHelper.get_New_Confirm_PasswordPair'(30)

WebUI.callTestCase(findTestCase('com.android.pages/com.create.account.pages/verify_password_contains_Text'), [:], FailureHandling.STOP_ON_FAILURE)

Mobile.clearText(findTestObject('Object Repository/Android/change_password_object_repository/android.widget.EditText - New password'), 
    0)

Mobile.clearText(findTestObject('Object Repository/Android/change_password_object_repository/android.widget.EditText - confirm password'), 
    0)
