...
otp = CustomKeywords.'kw_random.kw_Random.generateRandomInput'('numbers', 5)

Mobile.setText(findTestObject('Object Repository/Android/create_account_object_repository/android.widget.EditText (5)'), 
    otp, 0)

Mobile.verifyElementAttributeValue(findTestObject('Object Repository/Android/create_account_object_repository/android.widget.TextView - Submit'), 
    'enabled', 'false', 0)

sixdotp = CustomKeywords.'kw_random.kw_Random.generateRandomInput'('numbers', 6)

Mobile.setText(findTestObject('Object Repository/Android/create_account_object_repository/android.widget.EditText (5)'), 
    sixdotp, 0)

WebUI.callTestCase(findTestCase('com.android.pages/com.create.account.pages/Click_on_submit_code'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.android.pages/com.create.account.pages/verify_invalid_security_code'), [:], FailureHandling.STOP_ON_FAILURE)
