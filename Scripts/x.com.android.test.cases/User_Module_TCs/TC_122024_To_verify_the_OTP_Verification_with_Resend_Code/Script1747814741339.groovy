...
WebUI.callTestCase(findTestCase('com.android.pages/com.create.account.pages/Click_on_Resend_code'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('1.com.db/Enter_otp_Expired'), [:], FailureHandling.STOP_ON_FAILURE)
...
Mobile.clearText(findTestObject('Android/create_account_object_repository/android.widget.EditText (5)'), 0)
