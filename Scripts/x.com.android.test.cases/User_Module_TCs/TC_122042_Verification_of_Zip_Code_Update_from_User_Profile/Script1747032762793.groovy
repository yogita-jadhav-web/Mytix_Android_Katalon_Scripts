...
WebUI.callTestCase(findTestCase('com.android.pages/com.user.profile.pages/Click_on_User_profile_tab'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('com.android.pages/com.user.profile.pages/Update_Zip_postal_code'), [:], FailureHandling.STOP_ON_FAILURE)
